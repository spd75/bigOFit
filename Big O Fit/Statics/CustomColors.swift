...
class CustomColors {
    public static let darkishred: Color = Color(red: 200/255, green: 15/255, blue: 40/255, opacity: 0.7)
    public static let brightishGreen: Color = Color(red: 89/255, green: 201/255, blue: 165/255, opacity: 1)
    public static let grayBackground: Color = Color(red: 185/255, green: 185/255, blue: 185/255, opacity: 0.15)
